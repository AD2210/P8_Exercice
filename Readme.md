...
Vehiloc est une plateforme de gestion de vehicule de location
...
1 - Commencer par cloner le projet depuis le [gitHub](https://github.com/AD2210/P8_Exercice) dans votre ide
